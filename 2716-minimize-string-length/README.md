<h2><a href="https://leetcode.com/problems/minimize-string-length/description/">2825. Minimize String Length</a></h2><h3>Easy</h3><hr><p>Given a string <code>s</code>, you have two types of operation:</p>
